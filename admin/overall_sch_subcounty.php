                ...
                <div id="div_print" class="box">
                    <div class="container-fluid">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                            $add_result = $hteachergrade->selectOverallSchoolSubCounty($_POST);
                            if ($add_result) {
                                $select_result = $hteachergrade->selectOverallSchoolSubCounty($_POST);
                                ?>
                                <h3 class="text-center">Ranked Schools in <?php echo $sub_county . " Sub County in ". $filteryear; ?>  </h3>
                                <?php
                            } else {
                                $select_result = $hteachergrade->selectOverallSchoolSubCounty($_POST);
                            }
                                                                ...
                                                                foreach ($select_result as $sch_grade){
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                         ...
                                                                         ?></td>
                                                                         <td><?php echo  $i++;; ?></td>
                                                                         <td><?php echo $sch_grade['sch_category']; ?></td>
                                                                     </tr>
                                                                 </tbody>
