...
if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_update'])){
    $update_result=$teacher->updateh($_POST,$_FILES,$tea_id);
}
?>
<?php
//Select student by id
$single_teacher=$teacher->singleHTeacher($tea_id);
if($single_teacher){
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <br>
                <h3 class="text-center">Information of <b style="color: blue;"><?php echo $teacher_value['teacher_name']; ?></b></h3><br>
                <br>
                <div class="box-body">
                    <!----- student profile --------->
                    <div class="row">
