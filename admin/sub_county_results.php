...
if (ISSET($_POST['btn_submit'])) {
   ...
   if($stmt = $connection->query("SELECT sub_county, p_div_1  FROM sub_county_results where year='$sel_year'")){
...
var my_2d = ".json_encode($php_data_array)."
    ...
    if($stmt = $connection->query("SELECT sub_county, p_div_1  FROM sub_county_results where year='2018'")){
        $php_data_array = Array(); 
        while ($row = $stmt->fetch_row()) {
         $php_data_array[] = $row;
     }
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Schools P.L.E Grades </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <label for="tm">Filter P.L.E grades by Year</label>
                ...
                <div id="div_print" class="container-fluid">
                        ...
                        <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                                    $add_result = $hteachergrade->selectSubCountyResultsFilter($_POST);
                                    if ($add_result) {
                                        $select_result = $hteachergrade->selectSubCountyResultsFilter($_POST);
                                    } else {
                                        $select_result = $hteachergrade->selectSubCountyResultsFilter($_POST);
                                    }
                                } else {
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Graphical Representation of all Sub Counties Results </h3><br>
                    </div>
 ...
 google.charts.load('current', {'packages':['corechart']});
     ...
     google.charts.setOnLoadCallback(draw_my_chart);
      ...
      function draw_my_chart() {
        ...
        data.addColumn('string', 'sub county');
        data.addColumn('number', 'Division one Percent');
