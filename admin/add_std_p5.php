  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div class="box">
        ...
        <h3 class="text-center">Add <b style="color: red;">P5</b> Students of <b style="color: blue;"> <?php echo $school_value['sch_name']; ?></b></h3><br>
        <br>
        <div class="box-body">
          <!------ admission form submit here --------->
          <?php
          if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_submit'])){
            $add_students=$primaryfive->addStudents($_POST);
          }
          ?>
