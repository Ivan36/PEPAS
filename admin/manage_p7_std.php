            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="box-header">
                        ...
                        <a href="add_p7_std.php" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add</a>
                        ...
                        <a style="margin: 1px;" onclick="return confirm('Are you sure to Shift students?')" href="?shift_p7_result=<?php echo 'primary_seven_temp' . '-primary_seven' ?>" class="btn btn-sm btn-danger pull-right"><i class="glyphicon glyphicon-arrow-up"></i> Shift All as old students </a>
                            ...
                            <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                                ...
                                <tbody>
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                                        $add_result = $primaryseven->filterStudents($_POST);
                                        if ($add_result) {
                                            $select_result = $primaryseven->filterStudents($_POST);
                                        } else {
                                            $select_result = $primaryseven->filterStudents($_POST);
                                        }
                                    } else {
                                        $select_result = $primaryseven->selectTotalStudent();
                                    }
                                    $i = 1;
                                    if ($select_result) {
                                        foreach ($select_result as $value) {
