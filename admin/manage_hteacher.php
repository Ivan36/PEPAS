                ...
                <div class="box">
                    <div class="container-fluid">
                        <div class="box-header">
                            <h3 class="box-title">Total Head Teacher </h3>
                            <a href="add_hteacher.php" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add</a>
                            <a href="all-hteacher-profiles.php" class="btn btn-sm btn-success pull-right"><i class="fa fa-eye"></i> Get All Details</a>
                                    ...
                                    foreach ($select_result as $value){
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 25px">
                                                <a href="hteacher_profile.php?tea_id=<?php echo $value['id'] ?>" class="btn btn-success"><i class="glyphicon glyphicon-eye-open"></i> </a>
