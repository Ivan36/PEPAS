            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="box-header">
                        ...
                        <a href="all-hteacher-grades.php" class="btn btn-sm btn-success pull-right"><i class="fa fa-eye"></i> all P.L.E Results</a>
                        ...
                        <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                                    $add_result = $hteachergrade->selectTotalSchoolGradesFilter($_POST);
                                    if ($add_result) {
                                        $select_result = $hteachergrade->selectTotalSchoolGradesFilter($_POST);
                                    } else {
                                        $select_result = $hteachergrade->selectTotalSchoolGradesFilter($_POST);
                                    }
                                } else {
                                ...
                                if ($select_result) {
                                    foreach ($select_result as $value) {
                                        ...
                                        <tr>
                                           ...
                                           ?></td>
                                           <td style="padding-top: 35px"><?php echo $value['sub_county'] ?></td>
                                           <td style="padding-top: 35px"><?php echo $value['year'] ?></td>
                                           <td style="padding-top: 25px">
                                            <a href="sch_grades_profile.php?sch_id=<?php echo $value['id'] ?>" class="btn btn-success"><i class="glyphicon glyphicon-eye-open"></i> </a>
                                            <a onclick="return confirm('Are you sure to delete this field?')" href="?del_result=<?php echo $value['id'] . '-hteacher_grades' ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> </a>
                                        </td>
                                    </tr>
