            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="box-header">
                        ...
                        <a href="add_p4_std.php" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add</a>
                        ...
                        <a style="margin: 1px;" onclick="return confirm('Are you sure to Shift students?')" href="?shift_result=<?php echo 'primary_five' . '-primary_four' ?>" class="btn btn-sm btn-danger pull-right"><i class="glyphicon glyphicon-arrow-up"></i> Shift All to P5 </a>
                    ...
                    <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                               $add_result = $primaryfour->filterStudents($_POST);
                               if ($add_result) {
                                  $select_result = $primaryfour->filterStudents($_POST);
                              } else {
                                  $select_result = $primaryfour->filterStudents($_POST);
                              }
                          } else {
                           $select_result = $primaryfour->selectTotalStudent();
                       }
                       $i = 1;
                       if ($select_result) {
                           foreach ($select_result as $value) {
                              ...
                              <tr>
                                ...
                                <td style="padding-top: 25px">
                                    <a href="p4_std_profile.php?std_id=<?php echo $value['id'] ?>" class="btn btn-success"><i class="glyphicon glyphicon-eye-open"></i> </a>
                                    <a onclick="return confirm('Are you sure to delete this field?')" href="?del_result=<?php echo $value['id'] . '-primary_four' ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> </a>
                                </td>
                            </tr>
