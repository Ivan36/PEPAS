                ...
                <div class="box">
                    <div class="container-fluid">
                        <div class="box-header">
                            <h3 class="box-title" style="color: blue">Register Students in Primary Four (P4) Select School</h3>
                                ...
                                if($select_result){
                                    foreach ($select_result as $value){
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 35px"><?php echo "P4" ?></td>
                                            <td style="padding-top: 25px">
                                                <a href="add_std_p4.php?sch_id=<?php echo $value['id']; ?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-plus"></i> Add Students </a>
                                                
                                            </td>
                                            <td style="padding-top: 25px">
                                                <a href="add_p4_std_result.php?sch_name=<?php echo $value['sch_name']; ?>" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i> Add Results </a>
