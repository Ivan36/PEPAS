            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="box-header">
                        <h3 class="box-title" style="color: blue">Primary Seven (P7) Students P.L.E Results</h3>
                        ...
                        <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                                    $add_result = $primaryseven->filterResults($_POST);
                                    if ($add_result) {
                                        $select_result = $primaryseven->filterResults($_POST);
                                    } else {
                                        $select_result = $primaryseven->filterResults($_POST);
                                    }
                                } else {
                                    $select_result = $primaryseven->selectStudentResult();
                                }
                                $i = 1;
                                if ($select_result) {
                                    foreach ($select_result as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 25px">
                                                <a href="p7_result_profile.php?std_id=<?php echo $value['std_no']; ?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-eye-open"></i> </a>
