...
$single_student = $primaryfive->selectSingleResult($std_id);
if ($single_student) {
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a class="btn btn btn-default" href="Manage_p5_std_result.php" style=""><i class="fa fa-eye"></i> Manage Reults</a></li>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_update'])) {
    $update_result = $studentresults->updatep5Results($_POST, $std_id);
}
?>
<!-- Main content -->
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <div class="container-fluid">
                    <br>
                    <h3 class="text-center">Update Results of <b style="color:blue"> <?php echo $value['student_name']; ?></b> (Class: P5)</h3><br>
                    <br>
                    <div class="box-body">
                        <!----- student profile --------->
                        <div class="row">
