...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="box">
                <br>
                <h3 class="text-center">Add Teacher Grades Here</h3>
                <p class="text-center" style="color: red;">NB: If there are no students in acertain grade just leave it as Zero (0). Dont leave it blank</p>
                <br>
                <div class="box-body">
                    ...
                    if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_submit'])){
                        $add_result=$teachergrade->addGrade($_POST);
                    }
                    ?>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xs-10 col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <select name="teacher_name" id="se" class="form-control">
                                                ...
                                                $select_result=$teacherschool->selectTotalTeacherForm();
                                                ...
                                                if($select_result){
                                                    foreach ($select_result as $value){
                                                        ...
                                                        <option value="<?php echo $value['teacher_name']; ?>"><?php echo $value['teacher_name']." : ".$value['class']." : ".$value['subject']; ?>
                                                    </option>
                                                <?php }} ?>
                                            </select>
                                        </div>
