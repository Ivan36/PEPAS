...
<section class="content-header" style="margin-bottom: 5px;">
    ...
    <ol class="breadcrumb">
        <li><a class="btn btn btn-default" href="manage_p6_std.php" style=""><i class="fa fa-eye"></i> Manage Students</a></li>
            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 ">
                        <a href="update_p6_std.php?std_id=<?php echo $value['id']; ?>" type="submit" class="btn btn-info btn-block">Update Profile</a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-3"></div>
                </div>
