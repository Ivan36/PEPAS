...
<head>
    ...
    <style>
        .body-bg{
            background-image: url('assets/image/cropped.jpg');
                    ...
                    <div class="" id="heading1"> 
                        <div class="row"> 
                            <div class="col-lg-3 col-md-3">
                              <img src="../images/Uganda-flag-anim.gif"/>
                          
                              <img src="../images/mbarara logo.png"/>
                          </div>
                          <div class="col-lg-6 col-md-6">
                              <h3 class="text-center font-bold" id="full_oces_header">MBARARA DISTRICT LOCAL GOVERNMENT</h3>
                              <h4 class="text-center font-italic login mt-2" id="full_oces_header">Primary Education Performance Assessment System</h4>
                          </div>
                          <div class="col-lg-3 col-md-3">
                            <img src="../images/Coat_of_arms.png"  style="float: right;"/>
                            <img src="../images/mbarara logo.png"  style="float: right;"/>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card   mt-5 login-panel">
                        <div class="card-body bg-transparent">
                            <!-- <h5 class="text-center font-italic login mt-2"> </h5> -->
