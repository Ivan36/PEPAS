...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <a class="btn btn btn-default" href="manage_sch_mock_results.php" style="margin-left: 10px;"><i class="fa fa-eye"></i> Manage mock results</a>
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="box">
                <br>
                <h3 class="text-center">Add Head Teacher/School <b style="color: blue"> Mock Results</b> Here</h3>
                <p class="text-center" style="color: red; font-size: 16px;">NB: If there are no students in acertain grade just leave it as Zero (0). Dont leave it blank</p>
                <br>
                <div class="box-body">
                    ...
                    if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_submit'])){
                        $add_result=$hteachergrade->addMockResults($_POST);
                    }
                    ?>
