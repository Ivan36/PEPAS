...
$single_result=$primarysix->selectSingleResult($std_id);
if($single_result){
            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 ">
                        <a href="update_p6_result.php?std_id=<?php echo $value['std_no']; ?>" type="submit" class="btn btn-info btn-block">Update Result</a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-3"></div>
                </div>
