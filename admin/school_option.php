                ...
                <div class="box">
                    <div class="container-fluid">
                        <div class="box-header">
                            ...
                            <a href="add_school.php" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add</a>
                        </div><!-- /.box-header -->
                                ...
                                if($select_result){
                                    foreach ($select_result as $value){
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 35px"><?php echo $value['county'] ?></td>
                                            <td style="padding-top: 35px"><?php echo $value['sub_county'] ?></td>
                                            <td style="padding-top: 25px">
                                                <a href="schools_profile.php?sch_id=<?php echo $value['id']; ?>" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i> </a>
                                                <a onclick="return confirm('Are you sure to delete this field?')" href="?del_result=<?php echo $value['id'].'-schools_tb' ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> </a>
                                            </td>
                                        </tr>
