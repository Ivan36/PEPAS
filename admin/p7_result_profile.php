...
$single_result = $primaryseven->selectSingleResult($std_id);
if ($single_result) {
...
<section class="content-header" style="margin-bottom: 5px;">
    ...
    <ol class="breadcrumb">
        <li><a class="btn btn btn-default" href="Manage_p7_std_result.php" style=""><i class="fa fa-eye"></i> Manage Reults</a></li>
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <div class="container-fluid">
                    ...
                    <br>
                    <h3 class="text-center">P.L.E Results of <b style="color: blue;"><?php echo $value['student_name']; ?></b></h3><br>
                    <br>
                    <div class="box-body">
                        <!----- student profile --------->
                        <div class="row">
            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 ">
                        <a href="update_p7_result.php?std_id=<?php echo $value['std_no']; ?>" type="submit" class="btn btn-info btn-block">Update Result</a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-3"></div>
                </div>
