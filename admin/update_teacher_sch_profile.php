...
<section class="content-header" style="margin-bottom: 5px;">
    ...
    <ol class="breadcrumb">
        <a class="btn btn btn-default" href="teacher_grade_list.php" style="margin-left: 10px;"><i class="fa fa-eye"></i> Manage Teacher grades</a>
...
if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_update'])){
    $update_result=$teachergrade->updateGrades($_POST,$g_id);
}
?>
<?php
//Select student by id
$single_teacher_grade=$teachergrade->singleTeacherGrade($g_id);
if($single_teacher_grade){
    $value=$single_teacher_grade->fetch_assoc();
}
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <br>
                <h3 class="text-center">Update Grades of Teacher: <b style="color: blue;"><?php echo $value['teacher_name']; ?></b></h3><br>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-lg-6 col-xs-10 col-sm-10">
                                                                <div class="form-group">
                                                                    <label for="se">Teacher Name</label>
                                                                    <input type="text" id="sf" value="<?php echo $value['teacher_name'] ?>" class="form-control" name="teacher_name" readonly>
                                                                </div>
                                                                 <div class="form-group">
                                                                    <label for="tm">Class</label>
                                                                    <input type="text" name="class" id="se" class="form-control" value="<?php echo $value['class'] ?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-lg-6 col-xs-10 col-sm-10">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="tm">Subject</label>
                                                                    <input type="text" name="subject" id="se" class="form-control" value="<?php echo $value['subject'] ?>" readonly>
                                                                </div>
                                                                <div class="form-group">
