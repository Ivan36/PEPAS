...
class PrimarySevenClass
{
    ...
    public function addStudents($post)
    {
        ...
        $select_std = "SELECT id,school_name,student_name,class FROM primary_seven WHERE school_name='$school_name' AND student_name='$student_name'";
        ...
        $roll_query = "SELECT * FROM primary_seven";
        $roll_result = database::connect()->query($roll_query);
        if ($roll_result->num_rows <= 0) {
            $id = 70201;
            $query = "INSERT INTO primary_seven(id,student_name,school_name,std_no,sch_no,date_of_birth,home_address,district,gender,year)
            VALUES('$id','$student_name','$school_name','$id','$sch_no','$birth_date','$home_address','$district','$gender','$year')";
        } else {
            $id_select = "SELECT MAX(id) AS Max_Id from primary_seven";
            ...
            $query = "INSERT INTO primary_seven(student_name,school_name,std_no,sch_no,date_of_birth,home_address,district,gender,year)
    ...
    public function selectTotalStudent()
    {
        ...
        $std_query = "SELECT * FROM primary_seven WHERE status='active' ORDER BY school_name asc";
    ...
    public function selectSingleStudent($student_id)
    {
        ...
        $std_query = "SELECT * FROM primary_seven WHERE id='$student_id'";
        $result = database::connect()->query($std_query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
    ...
    public function updateStudent($post, $student_id)
    {
        ...
        $update_query = "UPDATE primary_seven SET 
    ...
    {
        $std_query = "SELECT student_name,std_no FROM primary_seven WHERE school_name='$school_name'";
        $result = database::connect()->query($std_query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
    ...
    public function selectStudentResult()
    {
        ...
        $rslt_query = "SELECT * FROM primary_seven_results WHERE status='active'";
    ...
    {
        $p_year= date("Y")-1;
        $rslt_query = "SELECT * FROM primary_seven_temp WHERE year='$p_year'";
        $result = database::connect()->query($rslt_query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
    ...
    public function selectSingleResult($student_no)
    {
        ...
        $query = "SELECT * FROM primary_seven_results WHERE std_no='$student_no'";
        $result = database::connect()->query($query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
    ...
    public function filterResults($post)
    {
        ...
        $query = "SELECT * FROM  primary_seven_results WHERE school_name='$school_name' AND year='$previous' ORDER By aggregates ASC";
    ...
    public function filterStudents($post)
    {
        ...
        $previous = $get_year - 1;
        $query = "SELECT * FROM  primary_seven where school_name='$school_name' ORDER By id ASC";
        $restlt = database::connect()->query($query);
        if ($restlt->num_rows > 0) {
            return $restlt;
        } else {
    ...
    public function filterOldStudents($post)
    {
        $get_year = date("Y")-1;
        $filteryear = $post['filteryear'];
        $school_name = $post['school_name'];
        ...
        $query = "SELECT * FROM  primary_seven_temp WHERE school_name='$school_name' AND year='$previous' ORDER By school_name ASC";
        $restlt = database::connect()->query($query);
        if ($restlt->num_rows > 0) {
            return $restlt;
        } else {
    ...
    public function selectMockResults()
    {

        $rslt_query = "SELECT * FROM primary_mock_results WHERE status='active' ORDER BY id DESC";
        $result = database::connect()->query($rslt_query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
    ...
    public function selectSingleMockResult($student_no)
    {

        $query = "SELECT * FROM primary_mock_results WHERE std_no='$student_no'";
        $result = database::connect()->query($query);
        if ($result->num_rows > 0) {
            return $result;
        } else {
