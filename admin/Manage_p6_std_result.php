...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="add_p6_std.php"><i class="fa fa-eye"></i>School Manage </a></li>
    </ol>
</section>
            ...
            <div class="box">
                <div class="container-fluid">
                    <div class="box-header">
                        <h3 class="box-title" style="color: blue">Primary Six (P6) Students Results</h3>
                        <a href="add_p6_std.php" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add Results</a>
                    </div><!-- /.box-header -->
                        ...
                        <table cellspacing="0" width="100%" id="example" class="display nowrap table table-striped table-bordered table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_submit'])) {
                                    $add_result = $primarysix->filterResults($_POST);
                                    if ($add_result) {
                                        $select_result = $primarysix->filterResults($_POST);
                                    } else {
                                        $select_result = $primarysix->filterResults($_POST);
                                    }
                                } else {
                                    $select_result = $primarysix->selectStudentResult();
                                }
                                $i = 1;
                                if ($select_result) {
                                    foreach ($select_result as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top: 25px">
                                                <a href="p6_result_profile.php?std_id=<?php echo $value['std_no']; ?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-eye-open"></i> </a>
