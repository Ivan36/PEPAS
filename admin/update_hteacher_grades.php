...
<section class="content-header" style="margin-bottom: 5px;">
    ...
    <ol class="breadcrumb">
        <a class="btn btn btn-default" href="hteacher_grades_list.php" style="margin-left: 10px;"><i class="fa fa-eye"></i> Manage Sch grades</a>
...
if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_update'])){
    $update_result=$hteachergrade->updateGrades($_POST,$g_id);
}
?>
<?php
//Select student by id
$single_hteacher_grade=$hteachergrade->singleSchoolGrade($g_id);
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <h3 class="text-center">Update P.L.E Results of <b style="color: blue;"><?php echo $value['school_name']." P/S"; ?></b></h3><br>
