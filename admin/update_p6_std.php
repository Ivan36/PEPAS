...
$single_student = $primarysix->selectSingleStudent($std_id);
if ($single_student) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_update'])) {
    $update_result = $primarysix->updateStudent($_POST, $std_id);
}
?>
<!-- Main content -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select class="form-control" name="gender">
                                                            ...
                                                            <option value="Other" <?php if ($value['gender'] == 'Other') {
                                                                                        echo "selected";
                                                                                    } ?>>Other</option>
                                                        </select>
                                                    </td>
                                                    <td>Date of Birth</td>
                                                    <td><input id="datePicker" name="birth_date" type="text" readonly class="form-control" value="<?php echo $value['date_of_birth'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td>Class</td>
