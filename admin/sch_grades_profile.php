...
$single_school_grade=$hteachergrade->singleSchoolGrade($sch_id);
if($single_school_grade){
    $sch_grade=$single_school_grade->fetch_assoc();
}
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 ">
             <a style="font-size: 18px" onClick="printdiv('div_print')"><i class="glyphicon glyphicon-print"></i> </a>
         </div>
    ...
    <div class="col-md-10">
        <div id="div_print" class="box">
            <div class="container-fluid">
                <h3 class="text-center">Performance of <b style="color: blue;"><?php echo $sch_grade['school_name']. " p/s in ". $sch_grade['year']; ?></b></h3><br>
                <div class="box-body">
                    <!----- student profile --------->
                    <div class="row">
                        <div class="col-md-1"></div>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-3 "></div>
                    <div class="col-lg-4 col-md-4 col-sm-4 ">
                        <a href="update_hteacher_grades.php?g_id=<?php echo $sch_grade['id']; ?>" type="submit" class="btn btn-info btn-block">Update school Grades</a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-3"></div>
                </div>
