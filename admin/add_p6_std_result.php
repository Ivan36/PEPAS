...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <a href="add_p6_std.php" class="btn btn-sm btn-default" style="margin-left: 10px;"><i class="fa fa-graduation-cap"></i> Manage Schools</a>
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="add_p6_std.php"><i class="fa fa-plus"></i>School Manage </a></li>
    <li class="">Profile</li>
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div class="box">
        ...
        <h3 class="text-center">Add <b style="color: red;">P6 </b> Results for Students of <b style="color: blue;"> <?php echo $school_value['sch_name']; ?></b></h3><br>
        <br>
        <div class="box-body">
          <!------ admission form submit here --------->
          <?php
          if($_SERVER['REQUEST_METHOD']== 'POST' && isset($_POST['btn_submit'])){
            $add_marks=$studentresults->addP6Results($_POST);
        }
        ?>
          ...
          <div class="col-md-6 col-lg-6 col-sm-10 col-xs-10">
            <div class="form-group">
                ...
                <select name="std_no" id="se" class="form-control">
                    ...
                    $select_result=$primarysix->selectStudentForm($sch_name);
