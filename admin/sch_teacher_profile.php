...
$single_schoolinfo=$teacherschool->singleSchTeacher($sch_id);
...
<section class="content-header" style="margin-bottom: 5px;">
    <h1> Dashboard <small>Full Teacher Info</small></h1>

    <ol class="breadcrumb">
        <li><a class="btn btn btn-default" href="manage_teacher_sch.php" style=""><i class="fa fa-eye"></i> Manage Teachers</a></li>
        ...
        <div class="col-md-10">
            <div id="div_print" class="box">
                <div class="container-fluid">
                    ...
                    <br>
                    <h3 class="text-center">Information of Teacher <b style="color: blue;"><?php echo $schoolinfo_value['teacher_name']; ?></b></h3><br>
                    <br>
                    <div class="box-body">
                        <!----- student profile --------->
                        <div class="row">
                                        ...
                                        <div class="row container-fluid">
                                            <div class="col-md-12 table-responsive">
                                                ...
                                                <table class="table table-responsive-sm ">
                                                    ...
                                                    <tr>
                                                        <td>School Name</td>
                                                        <td><?php echo $schoolinfo_value['school_name']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Teacher Names</td>
                                                        <td><?php echo $schoolinfo_value['teacher_name']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Class</td>
                                                        <td> <?php echo $schoolinfo_value['class']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Subject</td>
                                                        <td> <?php echo $schoolinfo_value['subject']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>School Number</td>
                                                    ...
                                                    <tr>
                                                        <td>Teacher Roll</td>
                                                        <td><?php echo $schoolinfo_value['teacher_roll']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Year</td>
