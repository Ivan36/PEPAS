...
<?php
mysqli_select_db('pat_db',mysqli_connect('localhost','root','IvanMata36'))or die(mysqli_error());
?>
...
<script type="application/javascript">
    ...
    <?php
    $query = mysqli_query("select * from sub_county_results where year='2017'") or die(mysqli_error());
